...
$files = @(
    ...
    @{ Source = 'apps/game2048.lua'; Destination = '/concordos/apps/game2048.lua' },
    ...
    @{ Source = 'apps/activity.lua'; Destination = '/concordos/apps/activity.lua' },
    ...
    @{ Source = 'system/lib/activity.lua'; Destination = '/concordos/system/lib/activity.lua' },
